...
func TestJsonFileSystem(t *testing.T) {
	...
	fs := swaggerui2.NewFileSystem(swaggerui2.WithJSONScheme([]byte(scheme)))
...
func TestYamlFileSystem(t *testing.T) {
	...
	fs := swaggerui2.NewFileSystem(swaggerui2.WithYAMLScheme([]byte(scheme)))
...
func TestRemoteFileSystem(t *testing.T) {
	...
	fs := swaggerui2.NewFileSystem(swaggerui2.WithRemoteScheme(`/my/cool/scheme?kek="`))
